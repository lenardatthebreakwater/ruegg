/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: bf72c8d64b1a675f65fc7cee87821db1)
// Runtime types generated with workerd@1.20260710.1 2026-06-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	CONTACT_ATTACHMENTS_R2: R2Bucket;
	CONTACT_SUBMISSIONS_DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	CONTACT_R2_ACCOUNT_ID: string;
	CONTACT_R2_BUCKET_NAME: string;
	CONTACT_R2_ACCESS_KEY_ID: string;
	CONTACT_R2_SECRET_ACCESS_KEY: string;
	CONTACT_R2_PUBLIC_BASE_URL: string;
	PRODUCT_REVALIDATE_SECRET: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	CF_ACCOUNT_ID: string;
	NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./cloudflare-worker").DOQueueHandler>;
	NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace<import("./cloudflare-worker").DOShardedTagCache>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "CONTACT_R2_ACCOUNT_ID" | "CONTACT_R2_BUCKET_NAME" | "CONTACT_R2_ACCESS_KEY_ID" | "CONTACT_R2_SECRET_ACCESS_KEY" | "CONTACT_R2_PUBLIC_BASE_URL" | "PRODUCT_REVALIDATE_SECRET" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "CF_ACCOUNT_ID">> {}
}
