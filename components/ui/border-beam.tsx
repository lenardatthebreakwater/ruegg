    ...
    >
      <motion.div
        ...
        style={
          {
            width: size,
            // Use inset() instead of rect(auto) for a stable closed border path
            // across viewport sizes (prevents mirrored/back-and-forth artifacts).
            offsetPath: "inset(0 round 1rem)",
